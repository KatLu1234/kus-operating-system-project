...
// PSI: copy memory-pressure averages to a user struct psi_data.
uint64
...
// System-wide kernel status: memory, runqueue and PSI (for statd).
// arg0: user pointer to struct sys_stat. Returns 0 on success, -1 on error.
uint64
